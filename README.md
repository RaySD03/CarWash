...
In addition, the project also relies on Google Firestore. As a result, the db should be configured for the list of agents for the application to function.
